      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-8 sm:py-12 pb-16 sm:pb-24">
        ...
        >
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-zinc-400 ml-2 sm:ml-4 text-sm sm:text-base">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">How We Use Your Data</h2>
            <p className="text-zinc-400 leading-relaxed text-sm sm:text-base">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">How We Protect Your Information</h2>
            <p className="text-zinc-400 leading-relaxed text-sm sm:text-base">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">Third-Party Services</h2>
            <p className="text-zinc-400 leading-relaxed text-sm sm:text-base">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-white">Updates to This Policy</h2>
            <p className="text-zinc-400 leading-relaxed text-sm sm:text-base">
